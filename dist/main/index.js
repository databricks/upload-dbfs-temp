...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.DATABRICKS_DBFS_DESTINATION_PATH_OUTPUT_KEY = exports.DBFS_UPLOAD_MAX_BYTES_PER_BLOCK = exports.DBFS_TMP_DIR_STATE_KEY = void 0;
exports.DBFS_TMP_DIR_STATE_KEY = '__DATABRICKS_DBFS_TMP_DIR';
exports.DBFS_UPLOAD_MAX_BYTES_PER_BLOCK = Math.pow(2, 20);
exports.DATABRICKS_DBFS_DESTINATION_PATH_OUTPUT_KEY = 'dbfs-file-path';
...
const core = __importStar(__nccwpck_require__(186));
const upload_dbfs_tempfile_1 = __nccwpck_require__(374);
const constants_1 = __nccwpck_require__(360);
const util = __importStar(__nccwpck_require__(494));
function runMainHelper() {
    return __awaiter(this, void 0, void 0, function* () {
        const databricksHost = util.getDatabricksHost();
        const databricksToken = util.getDatabricksToken();
        const localPath = util.getLocalPathInput();
        const dbfsTmpDir = util.getDbfsTempDir();
        const { dbfsUploadDirectory, dbfsUploadPath } = yield (0, upload_dbfs_tempfile_1.uploadDbfsTempfile)(databricksHost, databricksToken, localPath, dbfsTmpDir);
        core.saveState(constants_1.DBFS_TMP_DIR_STATE_KEY, dbfsUploadDirectory);
        core.setOutput(constants_1.DATABRICKS_DBFS_DESTINATION_PATH_OUTPUT_KEY, dbfsUploadPath);
    });
}
function runMain() {
    return __awaiter(this, void 0, void 0, function* () {
        yield util.runStepAndHandleFailure(runMainHelper);
    });
}
